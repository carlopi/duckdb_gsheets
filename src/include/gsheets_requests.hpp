...
std::string call_sheets_api(ClientContext &context, const std::string &spreadsheet_id, const std::string &token,
...
std::string get_spreadsheet_metadata(ClientContext &context, const std::string &spreadsheet_id,
