...
ReadSheetBindData::ReadSheetBindData(ClientContext &context, string spreadsheet_id, string token, bool header,
                                     string sheet_name, string sheet_range)
...
unique_ptr<FunctionData> ReadSheetBind(ClientContext &context, TableFunctionBindInput &input,
	...
	auto bind_data =
	    make_uniq<ReadSheetBindData>(context, spreadsheet_id, token, header, encoded_sheet_name, sheet_range);
